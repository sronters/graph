    ...
    return {
        ...
        "cells": [
            ...
            code(
                ...
                "download_receipt = {'archive': output_archive.name, 'archive_sha256': archive_sha256, 'git_commit': COMMIT, 'profile': PROFILE, 'seed': SEED, 'execution_platform': 'kaggle', 'source_mode': SOURCE_MODE}\n"
